    ...
    <div className="min-h-screen bg-gray-50 px-6 py-10">
      <div className="max-w-4xl mx-auto bg-white border rounded-xl p-8">
        ...
        <div className="flex gap-4">
          <Link href={`/dashboard/student/jobs/${id}/apply`} className="px-6 py-2 rounded-md bg-indigo-600 text-white hover:bg-indigo-700">
            Apply Now
          </Link>
          <button className="px-6 py-2 rounded-md border text-gray-700 hover:bg-gray-100">
            Save Job
          </button>
        </div>
      </div>
